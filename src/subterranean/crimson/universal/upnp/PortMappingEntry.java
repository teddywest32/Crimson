...
/**
 * A <tt>PortMappingEntry</tt> is the class used to represent port mappings on the
 * GatewayDevice.
 *
 * A port mapping on the GatewayDevice will allow all packets directed to port
 * <tt>externalPort</tt> of the external IP address of the GatewayDevice using the
 * specified <tt>protocol</tt> to be redirected to port <tt>internalPort</tt> of
 * <tt>internalClient</tt>.
 *
...
public class PortMappingEntry {
	...
	/**
	 * The protocol associated with this mapping (i.e. <tt>TCP</tt> or <tt>UDP</tt>)
	 */
	private String protocol;
	/**
	 * A flag that tells whether the mapping is enabled or not (<tt>"1"</tt> for enabled,
	 * <tt>"0"</tt> for disabled)
	 */
	private String enabled;
	/**
	 * A human readable description of the port mapping (used for display purposes)
	 */
