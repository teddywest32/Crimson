 ...
 * <p/>
 * It holds all the information that comes back as UPnP responses, and provides methods to
 * issue UPnP commands to a gateway.
 *
 * @author casta
 */
public class GatewayDevice {
	 ...
	 * <p/>
	 * Connects to the device's {@link #location} and parses the response using a
	...
	/**
	 * Issues UPnP commands to a GatewayDevice that can be reached at the specified
	 * <tt>url</tt>
	 * <p/>
	 * The command is identified by a <tt>service</tt> and an <tt>action</tt> and can
	 * receive arguments
	 *
	 * @param url
	 ...
	 * @return the response to the performed command, as a name-value map. In case errors
	 *         occur, the returned map will be <i>empty.</i>
	 * @throws IOException
	 *             on communication errors
	 * @throws SAXException
	 ...
	 * @throws IOException
	 * @throws SAXException
	 * @see #simpleUPnPcommand(java.lang.String, java.lang.String, java.lang.String,
	 *      java.util.Map)
	 */
	...
	/**
	 * Queries the GatewayDevice to retrieve a specific port mapping entry, corresponding
	 * to specified criteria, if present.
	 * <p/>
	 * Retrieves the <tt>PortMappingEntry</tt> associated with <tt>externalPort</tt> and
	 * <tt>protocol</tt>, if present.
	 *
	 * @param externalPort
	 *            the external port
	 * @param protocol
	 ...
	 * @throws IOException
	 * @throws SAXException
	 * @todo consider refactoring this method to make it consistent with Java practices
	 *       (return the port mapping)
	 * @see #simpleUPnPcommand(java.lang.String, java.lang.String, java.lang.String,
	 *      java.util.Map)
	 * @see PortMappingEntry
	 */
	public boolean getSpecificPortMappingEntry(int externalPort, String protocol, final PortMappingEntry portMappingEntry) throws IOException, SAXException {
	...
	/**
	 * Deletes the port mapping associated to <tt>externalPort</tt> and <tt>protocol</tt>
	 *
	 * @param externalPort
	 *            the external port
	 * @param protocol
