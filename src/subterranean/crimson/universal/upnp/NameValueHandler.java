...
public class NameValueHandler extends DefaultHandler {
	...
	/**
	 * Creates a new instance of a <tt>NameValueHandler</tt>, storing values in the
	 * supplied map
	 *
	 * @param nameValue
	 ...
	 *
	 * Caches the element as {@link #currentElement}, so that it will be stored as a map
	 ...
	 *
	 * It is used to reset currentElement when the XML node is closed. Note: this works
	 * only when the data we are interested in does not contain child nodes.
	 *
