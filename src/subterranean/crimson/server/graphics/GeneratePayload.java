...
import sl.SLPanel;
import sl.SLSide;
import subterranean.crimson.server.graphics.panels.generate.jar.Main;
import subterranean.crimson.universal.Platform;

public class GeneratePayload extends JFrame {
	...
	public GeneratePayload() {
		...
		if (!Platform.osx) {
			setIconImage(Toolkit.getDefaultToolkit().getImage(GeneratePayload.class.getResource("/subterranean/crimson/server/graphics/icons/menu/jar.png")));
		}
		setResizable(false);
		setTitle("Generate Jar Payload");
		...
		Notification notification = new Notification("Welcome to the Payload Generator!");
